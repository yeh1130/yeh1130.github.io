...
主要科目:  视觉传感技术93、模式识别 91 、程序设计基础 87、概率与统计87、图像处理与分析86、操作系统86、数据库原理85
...
- 针对基于各种大模型（LLMs）的聊天机器人中，探索用户每个问题更偏好哪个模型的回答，以改善聊天机器人与人类的互动。我们基于Gemma-2-9b-it模型进行微调，并且使用LORA方式進行高效調參构建对众多大模型（LLMs）择优的机器学习模型。
